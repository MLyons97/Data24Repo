...
class GoodGuy(MC.Person):
    def __init__(self, name: str, health: int, base_damage: int, weapon: str, ranged_weapon="", is_good=True, is_alive=True):
        super().__init__(name, health, base_damage, weapon, ranged_weapon, is_good, is_alive)


class BadGuy(MC.Person):
    def __init__(self, name: str, health: int, base_damage: int, weapon: str, ranged_weapon="", is_good=False, is_alive=True):
        super().__init__(name, health, base_damage, weapon, ranged_weapon, is_good, is_alive)
...
# blacksmith = Shopkeeper("gary", 5000000000000000000, swords)
#
...
list_of_good_names = ["Jimmy", "Pieface", "Pinky", "Robin", "Bluebird", "Snapper", "Dan", "Doiby", "Fatman", "Pete Ross", "Sandy", "Squire", "Bucky", "Rick Jones", "Toro", "Bert", "Chippy"]
list_of_bad_names = ["Wiggins", "LeFou", "Horace", "Jasper", "Flotsam", "Jetsam", "Gaston", "Kronk", "Mr. Smee", "Shenzl", "Banzai", "Ed", "Edd", "Eddy", "Annie", "Harry Warden", "Billy", "Freddy", "Jason"]
list_of_sidekicks = ["Perilous Paula", "Not-Nice Nish", "Masterful Martin"]
list_of_doctor_names = ["Capaldi", "Smith", "Tennant", "Eccleston", "Baker", "Hartnell", "Davison", "Pertwee", "Baker", "Grant", "Atkinson"]